 ...
 * generated in the ma.mehdi.Client.proxy package. 
...
public class ObjectFactory {
    ...
    private static final QName _Convert_QNAME = new QName("http://Service.mehdi.ma/", "convert");
    private static final QName _ConvertResponse_QNAME = new QName("http://Service.mehdi.ma/", "convertResponse");
    private static final QName _GetCompte_QNAME = new QName("http://Service.mehdi.ma/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://Service.mehdi.ma/", "getCompteResponse");
    private static final QName _ListComptes_QNAME = new QName("http://Service.mehdi.ma/", "listComptes");
    private static final QName _ListComptesResponse_QNAME = new QName("http://Service.mehdi.ma/", "listComptesResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ma.mehdi.Client.proxy
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://Service.mehdi.ma/", name = "convert")
     ...
     */
    @XmlElementDecl(namespace = "http://Service.mehdi.ma/", name = "convertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://Service.mehdi.ma/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://Service.mehdi.ma/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://Service.mehdi.ma/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://Service.mehdi.ma/", name = "listComptesResponse")
