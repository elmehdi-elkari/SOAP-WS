 ...
 * 
 */
@WebServiceClient(name = "BankWs", targetNamespace = "http://Service.mehdi.ma/", wsdlLocation = "http://localhost:1010/BankWs?wsdl")
public class BankWs
    extends Service
{
    ...
    private static final QName BANKWS_QNAME = new QName("http://Service.mehdi.ma/", "BankWs");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1010/BankWs?wsdl");
    ...
    public BankService getBankServicePort() {
        return super.getPort(new QName("http://Service.mehdi.ma/", "BankServicePort"), BankService.class);
    }
    ...
    public BankService getBankServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Service.mehdi.ma/", "BankServicePort"), BankService.class, features);
    }
